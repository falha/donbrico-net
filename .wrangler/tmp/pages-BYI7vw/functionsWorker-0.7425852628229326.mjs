...
// api/resolve-license.js
async function resolveLicenseRequest(request, env) {
  const url = new URL(request.url);
  ...
  const apiKey = isTestMode ? env.DODO_PAYMENTS_API_KEY_TEST || legacyApiKey : env.DODO_PAYMENTS_API_KEY_LIVE || legacyApiKey;
  if (!apiKey) {
  ...
  const defaultApiBaseUrl = isTestMode ? "https://test.dodopayments.com" : "https://live.dodopayments.com";
  const modeApiBaseUrl = isTestMode ? env.DODO_PAYMENTS_API_BASE_URL_TEST : env.DODO_PAYMENTS_API_BASE_URL_LIVE;
  ...
  try {
    ...
    const matched = items.find((item) => {
      ...
      const itemSubscriptionId = String(
        item.subscription_id || item.subscriptionId || item.subscription?.id || ""
      ).trim();
      ...
      const itemProduct = String(
        item.product_key || item.productKey || item.product?.key || ""
      ).trim().toLowerCase();
      if (!itemProduct) {
        return true;
      }
    ...
    const licenseKey = String(
      fallbackMatched?.key || fallbackMatched?.license_key || fallbackMatched?.licenseKey || ""
    ).trim();
    if (!licenseKey) {
      const subscriptionStatus = String(subscriptionData.status || "").trim().toLowerCase();
      const retryableSubscriptionStates = /* @__PURE__ */ new Set(["active", "trialing", "incomplete", "past_due"]);
...
__name(resolveLicenseRequest, "resolveLicenseRequest");
async function onRequestGet2(context) {
  return resolveLicenseRequest(context.request, context.env);
}
__name(onRequestGet2, "onRequestGet");

// ../.wrangler/tmp/pages-BYI7vw/functionsRoutes-0.9027443359801208.mjs
var routes = [
  {
...
// ../../../Users/Do/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../Users/Do/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../Users/Do/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../Users/Do/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-nnjiIM/middleware-insertion-facade.js
...
// ../../../Users/Do/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-nnjiIM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7425852628229326.mjs.map
