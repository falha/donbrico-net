...
print("Loading missing_zh_TW.json...")
with open('locales/missing_zh_TW.json', encoding='utf-8') as f:
    missing_data = json.load(f)

print(f"Found {len(missing_data)} missing keys")

print("Loading zh_TW.json...")
with open('locales/zh_TW.json', encoding='utf-8') as f:
...
for key, value in missing_data.items():
    ...
    translated_value = translate_value(value, 'zh-TW')
    set_nested(zh_tw_data, key, translated_value)

print(f"Completed: {count}/{len(missing_data)}")

print("Saving zh_TW.json...")
with open('locales/zh_TW.json', 'w', encoding='utf-8') as f:
