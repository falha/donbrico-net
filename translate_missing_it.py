...
print("Loading missing_it.json...")
with open('locales/missing_it.json', encoding='utf-8') as f:
    missing_data = json.load(f)

print(f"Found {len(missing_data)} missing keys")

print("Loading it.json...")
with open('locales/it.json', encoding='utf-8') as f:
    it_data = json.load(f)
...
for key, value in missing_data.items():
    ...
    translated_value = translate_value(value, 'it')
    set_nested(it_data, key, translated_value)

print(f"Completed: {count}/{len(missing_data)}")

print("Saving it.json...")
with open('locales/it.json', 'w', encoding='utf-8') as f:
