...
print("Loading Portuguese Brazil file...")
with open('locales/pt_BR.json', encoding='utf-8') as f:
    pt_br_data = json.load(f)

print("Translating to Portuguese Brazil...")
for key, en_value in en_values.items():
    translated_value = translate_value(en_value, 'pt')
    set_nested(pt_br_data, key, translated_value)

print("Saving Portuguese Brazil file...")
